...
# How To Use
## Step0. 구글 확장 프로그램 설치
[설치하러 가기](https://chromewebstore.google.com/detail/fedlhlkkbmflfhmeffadldpojnielkgn?hl=ko&utm_source=ext_sidebar)
<br>

## Step1. 프로그램 들어가기
KLAS 접속 후 메인화면 상단에서 버튼을 클릭해 희망하는 프로그램에 접속<br>
...
✔️ **수강 예정** 과목,**재수강 예정**인 과목의 **성적**을 조정해 계산하기 버튼을 눌러 **예상 학점**을 확인 <br>
✔️ **학적부 성적**이 필요한 학생들을 위해 따로 F 테이블 확인 및 관리
